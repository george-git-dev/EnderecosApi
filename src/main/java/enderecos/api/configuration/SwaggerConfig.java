package enderecos.api.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("enderecos.api.controller")).paths(PathSelectors.any())
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Endereço").description("Projeto API Spring - endereço API")
